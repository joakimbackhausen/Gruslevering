...
var AccordionRoot = ut(Sm.Root)`
  border: 1px solid
    ${({ theme, $error }) => $error ? theme.colors.danger600 : theme.colors.neutral200};
`;
var ContextMenuTrigger = ut(Am.Trigger)`
  :hover,
  :focus {
...
var NestedOption = ut(Wa)`
  padding-left: ${({ theme }) => theme.spaces[7]};
`;
var PermissionWrapper = ut(T)`
  > * {
    flex-grow: 1;
  }
`;
...
var NestedOption2 = ut(Wa)`
  padding-left: ${({ theme }) => theme.spaces[7]};
`;
var ContentTypeTakeNotice = ut(I)`
  font-style: italic;
`;
...
//# sourceMappingURL=id-U3O462FD.js.map

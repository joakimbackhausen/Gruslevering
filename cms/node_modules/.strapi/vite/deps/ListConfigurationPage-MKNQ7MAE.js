import {
  CardDragPreview
} from "./chunk-AG54RJLE.js";
import {
  FieldTypeIcon
} from "./chunk-6PLEN7TH.js";
import {
  useTypedSelector
...
`;
var DragButton = ut(ActionButton)`
  padding: 0 ${({ theme }) => theme.spaces[3]};
  border-right: 1px solid ${({ theme }) => theme.colors.neutral150};
  cursor: all-scroll;
`;
var FieldContainer = ut(T)`
  max-height: 3.2rem;
  cursor: pointer;
`;
var FieldWrapper = ut(R)`
  &:last-child {
...
//# sourceMappingURL=ListConfigurationPage-MKNQ7MAE.js.map

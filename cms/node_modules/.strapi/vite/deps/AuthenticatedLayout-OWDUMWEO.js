...
`;
var MainNavLinkWrapper = ut(NavLink)`
  ${MainNavLinkStyles}
`;
var MainNavLinkAnchor = ut.a`
  ${MainNavLinkStyles}
`;
var MainNavButtonStyles = it`
  padding-block: 1rem;
  padding-inline: 1rem;
`;
var MainNavButtonWrapper = ut(MainNavLinkWrapper)`
  ${MainNavButtonStyles}
`;
var MainNavButtonAnchor = ut(MainNavLinkAnchor)`
  ${MainNavButtonStyles}
`;
...
// node_modules/@strapi/admin/dist/admin/admin/src/components/MainNav/MainNavLinks.mjs
var NavLinkBadgeLock = ut(NavLink2.Badge)`
  background-color: transparent;
`;
var NavLinkBadgeCounter = ut(NavLink2.Badge)`
  span {
...
//# sourceMappingURL=AuthenticatedLayout-OWDUMWEO.js.map

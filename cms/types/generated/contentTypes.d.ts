...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    status: Schema.Attribute.Enumeration<
      ['modtaget', 'bekraeftet', 'under_levering', 'leveret']
    > &
      Schema.Attribute.DefaultTo<'modtaget'>;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    deliveryIncluded: Schema.Attribute.Boolean &
    ...
    tieredPricing: Schema.Attribute.JSON;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    unit: Schema.Attribute.Enumeration<['bigbag', 'saek', 'stk', 'm3']> &
      Schema.Attribute.DefaultTo<'bigbag'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiSiteSettingSiteSetting extends Struct.SingleTypeSchema {
  ...
  attributes: {
    address: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Tylstrupvej 1, 9382 Tylstrup'>;
    companyName: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'K\u00E6rvang Materialer ApS'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    email: Schema.Attribute.Email &
      Schema.Attribute.DefaultTo<'Info@kaervangmaterialer.dk'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    phone: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'+45 72 49 44 44'>;
    publishedAt: Schema.Attribute.DateTime;
    socialMedia: Schema.Attribute.JSON;
    trustpilotUrl: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
